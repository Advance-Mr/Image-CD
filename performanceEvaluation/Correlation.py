...
def correlation(img,N=3000):
  ...
  plt.title('原图像')
  f = plt.gcf()  # 获取当前图像
  f1 = f.savefig(r'D:\Image-Encryption-Decryption-main\AnalysisImg\OriCor.png', format='png')
  f.clear()  # 释放内存
  #子图2
  ...
  plt.title('通道R')
  f = plt.gcf()  # 获取当前图像
  f2 = f.savefig(r'D:\Image-Encryption-Decryption-main\AnalysisImg\OriCorR.png', format='png')
  f.clear()  # 释放内存
  ...
  plt.title('通道G')
  f = plt.gcf()  # 获取当前图像
  f3 = f.savefig(r'D:\Image-Encryption-Decryption-main\AnalysisImg\OriCorGn.png', format='png')
  f.clear()  # 释放内存
  #子图4
  ...
  plt.title('通道B')
  f = plt.gcf()  # 获取当前图像
  f4 = f.savefig(r'D:\Image-Encryption-Decryption-main\AnalysisImg\OriCorB.png', format='png')
  f.clear()  # 释放内存
